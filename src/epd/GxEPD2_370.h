...
#ifndef _GxEPD2_370_H_
#define _GxEPD2_370_H_

#include "../GxEPD2_4G_EPD.h"

class GxEPD2_370 : public GxEPD2_4G_EPD
{
  public:
    // attributes
    ...
    static const uint16_t full_refresh_time = 3000; // ms, e.g. 5406814us
    static const uint16_t partial_refresh_time = 400; // ms, e.g. 458231us
    // constructor
    GxEPD2_370(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
